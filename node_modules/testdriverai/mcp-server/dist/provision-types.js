 ...
 */
export const ProvisionTypes = ["chrome", "chromeExtension", "vscode", "installer", "electron"];
// ====================================
...
export const SessionStartInputSchema = z.object({
    ...
    type: z.enum(ProvisionTypes).default("chrome").describe("Provision type: 'chrome' (browser), 'chromeExtension' (browser with extension), 'vscode' (VS Code), 'installer' (download and install app), 'electron' (Electron app)"),
    // Chrome options
 ...
 */
export function getProvisionOptions(params) {
    switch (params.type) {
        case "chrome":
            return {
